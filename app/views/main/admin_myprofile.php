        ...
        <div id="sign_in" class="Xpop-up dashboard">
            ...
            <div class="pop-up-details dashboardf">
                ...
                <div class="dashboard_contents">
                    ...
                    <form action="<?php echo getUrl('admin/main/myprofile') ?>" method="post" id="editprofile" name="editprofile">
                        ...
                        <table width="1002" border="0">
                            ...
                            <tr>
                                <td>Email Address</td>
                                <td><input type="email" id="username" autocomplete="off" value="<?php echo $authuser->username; ?>" required="required" name="username">
