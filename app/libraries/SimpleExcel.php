 ...
 *
 * Example 1:
 * if ( $xlsx = SimpleExcel::parse('book.xlsx') ) {
 *   print_r( $xlsx->rows() );
 * } else {
 *   echo SimpleExcel::parseError();
 * }
 *
 ...
 *
 * Example 3: rowsEx
 * $xlsx = SimpleExcel::parse('book.xlsx');
 * print_r( $xlsx->rowsEx() );
 *
 ...
 *
 * Example 8: read data
 * if ( $xlsx = SimpleExcel::parse( file_get_contents('http://www.example.com/example.xlsx'), true) ) {
 ...
 *
 * Example 9: old style
 * $xlsx = new SimpleExcel('book.xlsx');
 * if ( $xlsx->success() ) {
 *   print_r( $xlsx->rows() );
 * } else {
