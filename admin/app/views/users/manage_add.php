        ...
        <div id="sign_in" class="Xpop-up dashboard">
            ...
            <div class="pop-up-details dashboardf">
                ...
                <div class="dashboard_contents">
                    ...
                    <form action="<?php echo getUrl('manage/users/edit') ?>/<?php echo $user->id ?>" method="post" id="editprofile" name="editprofile" enctype="multipart/form-data">
                        <input type="hidden" id="id" name="id" value="<?php echo $user->id; ?>">
                        <table width="1002" border="0">
                            <tr>
                                <td>First Name</td>
                                <td><input type="text" id="firstname" required="required" name="firstname" value="<?php echo $user->firstname; ?>"></td>
                            </tr>
                            <tr>
                                <td>Last Name</td>
                                <td><input type="text" id="lastname" required="required" value="<?php echo $user->lastname; ?>" name="lastname"></td>
                            </tr>
                            <tr>
                                <td>Email Address</td>
                                <td><input type="email" id="username" autocomplete="off" value="<?php echo $user->username; ?>" required="required" name="username">
                                    <span id="handle_status"> </span></td>
                            </tr>
                            <tr>
                                <td>Password</td>
                                <td><input type="password" id="password"  value=""  name="password" autocomplete="off" pattern="(?=^.{6,46}$)((?=.*\d)|(?=.*\W+))(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$">
                            ...
                            <tr>
                                <td>&nbsp;</td>
                                <td>
                                    <input type='hidden' id='country' name='country' value='NP'>
