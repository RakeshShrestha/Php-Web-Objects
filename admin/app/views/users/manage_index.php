                    ...
                    <table width="100%" border="0">
                        ...
                        foreach ($users as $user) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo getUrl('manage/users/edit') ?>/<?php echo $user->id ?>">
                                        Edit
                                    </a>
                                    | 
                                    <?php
                                    if ($user->status == 1) {
                                        ?>
                                        <a href="<?php echo getUrl('manage/users/disable') ?>/<?php echo $user->id ?>">
                                            Disable
                                        </a>
                                        <?php
                                    }
                                    ...
                                    if ($user->status == 2) {
                                        ?>
                                        <a href="<?php echo getUrl('manage/users/enable') ?>/<?php echo $user->id ?>">
                                            Enable
                                        </a>
                                        <?php
                                    }
